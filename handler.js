...
exports.handler = async (event, context, callback) => {
  ...
  try {
    ...
    if (
      ...
      event.response.emailMessage = identity(link, email);
...
const encryptSub = sub => {
  if (sub) return CryptoJS.AES.encrypt(sub, process.enc.SECRET_KEY).toString();
};
...
//   callerContext: {awsSdkVersion: 'aws-sdk-unknown-unknown', clientId: '2a0v2nl3jssdrj4rov2kv7515u'},
